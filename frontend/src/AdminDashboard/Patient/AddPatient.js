...
const AddPatient = () => {
  ...
  const onSubmit = async (e) => {
    ...
    List.BGroup = List.BGroup.toString();
    List.MStatus = List.MStatus.toString();
    ...
    formData.append('PreferTo', List.PreferTo);
    formData.append('MStatus', List.MStatus);
    formData.append('Address', List.Address);
    formData.append('Occupation', List.Occupation);
    formData.append('Mobile', List.Mobile);
    formData.append('History', List.History);
    ...
    try {
      const response = await fetch("http://127.0.0.1:8001/api/patient", {
        method: "POST",
        body:formData,
          ...
          <Nav className="flex-column" defaultActiveKey={"#home"}>
            ...
            <Nav.Item>
              ...
              <Collapse in={open2} id="bar-patient" className="navItem">
                <Card>
                  <Card.Body>
                    <Button variant="light">Add Patient</Button>
