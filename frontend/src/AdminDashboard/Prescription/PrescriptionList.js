...
const PrescriptionList = () => {
  ...
  const getData = async () => {
    const response = await fetch("http://127.0.0.1:8001/api/Pview", {
      method: "GET",
      headers: {
  ...
  const onDelete = async (id) => {
    ...
    const response = await fetch(`http://127.0.0.1:8001/api/Predelete/${id}`, {
      method: "DELETE",
      headers: {
        "Content-Type": "application/json",
      },
  ...
  const onEdit = async (id) => {
    ...
    const response = await fetch(`http://127.0.0.1:8001/api/Preedit/${id}`, {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
      },
  ...
  const onSubmit = async (e) => {
    ...
    const response = await fetch("http://127.0.0.1:8001/api/Preupdate/"+id, {
      method: "PUT",
